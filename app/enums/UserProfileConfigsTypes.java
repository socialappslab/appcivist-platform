...
public class UserProfileConfigsTypes {
   ...
   public static List<String> list = Arrays.asList("notifications.default.service",
            ...
            "notifications.preference.campaign-newsletters.auto-subscription",
            "notifications.preference.newsletter.frequency",
            "notifications.preference.newsletter.service",
