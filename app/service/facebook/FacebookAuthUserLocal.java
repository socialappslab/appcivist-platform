...
public class FacebookAuthUserLocal extends BasicOAuth2AuthUser implements
    ...
    public FacebookAuthUserLocal(final JsonNode node, final FacebookAuthInfoLocal info,
                            final String state) {
    ...
    public String getProvider() {
        return FacebookAuthProviderLocal.PROVIDER_KEY;
    }
