...
public class Users extends Controller {
  ...
  @ApiImplicitParams({ @ApiImplicitParam(name = "login_form", value = "User's Login Credentials",
          paramType = "body") })
  ...
  public static Result createFbToken(Long uid) {
    ...
    tokenAction.save();
    String responseMsg = createSocialIdeationUser(form.get("userId"), form.get("accessToken"), UUID.fromString(form.get("auuid")));
  ...
  public static String createSocialIdeationUser(String userId, String fbToken, UUID assemblyUuid){

    Config endpoint = Config.findByTypeAndKey(assemblyUuid, ConfigTargets.ASSEMBLY, "appcivist.assembly.social-ideation-new-user-url").get(0);
    Config initiative_url = Config.findByTypeAndKey(assemblyUuid, ConfigTargets.ASSEMBLY, "appcivist.assembly.social-ideation-initiative-url").get(0);
