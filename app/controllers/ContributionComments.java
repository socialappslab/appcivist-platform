...
public class ContributionComments extends Contributions {
	...
	public static final ContributionTypes cType = ContributionTypes.COMMENT;
	...
	@Dynamic(value = "MemberOfAssembly", meta = SecurityModelConstants.ASSEMBLY_RESOURCE_PATH)
	public static Result findComment(Long aid, Long id) {
	...
	// the user
	@Dynamic(value = "MemberOfAssembly", meta = SecurityModelConstants.ASSEMBLY_RESOURCE_PATH)
	public static Result updateComment(Long aid, Long id) {
	...
	public static Result deleteComment(Long aid, Long contributionId) {
		Contribution.deleteContributionByIdAndType(contributionId, cType);
		return ok();
	}

	@Dynamic(value = "MemberOfAssembly", meta = SecurityModelConstants.ASSEMBLY_RESOURCE_PATH)
	public static Result createComment(Long aid) {
