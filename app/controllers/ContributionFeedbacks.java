...
public class ContributionFeedbacks extends Contributions {
	...
	public static final ContributionTypes cType = ContributionTypes.FEEDBACK;
	...
	@Dynamic(value = "MemberOfAssembly", meta = SecurityModelConstants.ASSEMBLY_RESOURCE_PATH)
	public static Result findFeedback(Long aid, Long id) {
	...
	// the user
	@Dynamic(value = "MemberOfAssembly", meta = SecurityModelConstants.ASSEMBLY_RESOURCE_PATH)
	public static Result updateFeedback(Long aid, Long id) {
	...
	public static Result deleteFeedback(Long aid, Long contributionId) {
		Contribution.deleteContributionByIdAndType(contributionId, cType);
		return ok();
	}

	@Dynamic(value = "MemberOfAssembly", meta = SecurityModelConstants.ASSEMBLY_RESOURCE_PATH)
	public static Result createFeedback(Long aid) {
