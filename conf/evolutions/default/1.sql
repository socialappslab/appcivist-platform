...
alter table config add constraint fk_config_campaign_phase_8 foreign key (campaign_phase_phase_id) references campaign_phase (phase_id);
create index ix_config_campaign_phase_8 on config (campaign_phase_phase_id);
...
alter table membership add constraint fk_membership_organization_17 foreign key (organization_assembly_id) references assembly (assembly_id);
create index ix_membership_organization_17 on membership (organization_assembly_id);
alter table membership add constraint fk_membership_workingGroup_18 foreign key (working_group_group_id) references working_group (group_id);
create index ix_membership_workingGroup_18 on membership (working_group_group_id);
alter table message add constraint fk_message_targetUser_19 foreign key (target_user_user_id) references appcivist_user (user_id);
create index ix_message_targetUser_19 on message (target_user_user_id);
alter table message add constraint fk_message_targetWorkingGroup_20 foreign key (target_working_group_group_id) references working_group (group_id);
create index ix_message_targetWorkingGroup_20 on message (target_working_group_group_id);
alter table message add constraint fk_message_targetAssembly_21 foreign key (target_assembly_assembly_id) references assembly (assembly_id);
create index ix_message_targetAssembly_21 on message (target_assembly_assembly_id);
...
alter table required_campaign_configuration add constraint fk_required_campaign_configur_23 foreign key (phase_definition_phase_definition_id) references phase_definition (phase_definition_id);
create index ix_required_campaign_configur_23 on required_campaign_configuration (phase_definition_phase_definition_id);
alter table required_campaign_configuration add constraint fk_required_campaign_configur_24 foreign key (configuration_config_id) references config (config_id);
create index ix_required_campaign_configur_24 on required_campaign_configuration (configuration_config_id);
alter table required_phase_configuration add constraint fk_required_phase_configurati_25 foreign key (phase_definition_phase_definition_id) references phase_definition (phase_definition_id);
create index ix_required_phase_configurati_25 on required_phase_configuration (phase_definition_phase_definition_id);
alter table required_phase_configuration add constraint fk_required_phase_configurati_26 foreign key (config_definition_config_definition_id) references config_definition (config_definition_id);
create index ix_required_phase_configurati_26 on required_phase_configuration (config_definition_config_definition_id);
alter table resource add constraint fk_resource_contribution_27 foreign key (contribution_contribution_id) references contribution (contribution_id);
create index ix_resource_contribution_27 on resource (contribution_contribution_id);
alter table resource add constraint fk_resource_location_28 foreign key (location_location_id) references geo (location_id);
create index ix_resource_location_28 on resource (location_location_id);
