...
alter table config add constraint fk_config_assembly_8 foreign key (assembly_assembly_id) references assembly (assembly_id);
create index ix_config_assembly_8 on config (assembly_assembly_id);
alter table config add constraint fk_config_definition_9 foreign key (definition_config_definition_id) references config_definition (config_definition_id);
create index ix_config_definition_9 on config (definition_config_definition_id);
alter table contribution add constraint fk_contribution_assembly_10 foreign key (assembly_assembly_id) references assembly (assembly_id);
create index ix_contribution_assembly_10 on contribution (assembly_assembly_id);
alter table contribution add constraint fk_contribution_location_11 foreign key (location_location_id) references geo (location_id);
create index ix_contribution_location_11 on contribution (location_location_id);
alter table contribution_connection add constraint fk_contribution_connection_so_12 foreign key (source_contribution_contribution_id) references contribution (contribution_id);
create index ix_contribution_connection_so_12 on contribution_connection (source_contribution_contribution_id);
alter table contribution_connection add constraint fk_contribution_connection_ta_13 foreign key (target_contribution_contribution_id) references contribution (contribution_id);
create index ix_contribution_connection_ta_13 on contribution_connection (target_contribution_contribution_id);
alter table geometry add constraint fk_geometry_geo_14 foreign key (geo_location_id) references geo (location_id);
create index ix_geometry_geo_14 on geometry (geo_location_id);
alter table Linked_Account add constraint fk_Linked_Account_user_15 foreign key (user_id) references appcivist_user (user_id);
create index ix_Linked_Account_user_15 on Linked_Account (user_id);
alter table membership add constraint fk_membership_user_16 foreign key (user_user_id) references appcivist_user (user_id);
create index ix_membership_user_16 on membership (user_user_id);
alter table membership add constraint fk_membership_role_17 foreign key (role_role_id) references role (role_id);
create index ix_membership_role_17 on membership (role_role_id);
alter table membership add constraint fk_membership_organization_18 foreign key (organization_assembly_id) references assembly (assembly_id);
create index ix_membership_organization_18 on membership (organization_assembly_id);
alter table membership add constraint fk_membership_workingGroup_19 foreign key (working_group_group_id) references working_group (group_id);
create index ix_membership_workingGroup_19 on membership (working_group_group_id);
alter table message add constraint fk_message_targetUser_20 foreign key (target_user_user_id) references appcivist_user (user_id);
create index ix_message_targetUser_20 on message (target_user_user_id);
alter table message add constraint fk_message_targetWorkingGroup_21 foreign key (target_working_group_group_id) references working_group (group_id);
create index ix_message_targetWorkingGroup_21 on message (target_working_group_group_id);
alter table message add constraint fk_message_targetAssembly_22 foreign key (target_assembly_assembly_id) references assembly (assembly_id);
create index ix_message_targetAssembly_22 on message (target_assembly_assembly_id);
alter table properties add constraint fk_properties_geo_23 foreign key (geo_location_id) references geo (location_id);
create index ix_properties_geo_23 on properties (geo_location_id);
alter table required_campaign_configuration add constraint fk_required_campaign_configur_24 foreign key (phase_definition_phase_definition_id) references phase_definition (phase_definition_id);
create index ix_required_campaign_configur_24 on required_campaign_configuration (phase_definition_phase_definition_id);
alter table required_campaign_configuration add constraint fk_required_campaign_configur_25 foreign key (configuration_config_id) references config (config_id);
create index ix_required_campaign_configur_25 on required_campaign_configuration (configuration_config_id);
alter table required_phase_configuration add constraint fk_required_phase_configurati_26 foreign key (phase_definition_phase_definition_id) references phase_definition (phase_definition_id);
create index ix_required_phase_configurati_26 on required_phase_configuration (phase_definition_phase_definition_id);
alter table required_phase_configuration add constraint fk_required_phase_configurati_27 foreign key (config_definition_config_definition_id) references config_definition (config_definition_id);
create index ix_required_phase_configurati_27 on required_phase_configuration (config_definition_config_definition_id);
alter table resource add constraint fk_resource_contribution_28 foreign key (contribution_contribution_id) references contribution (contribution_id);
create index ix_resource_contribution_28 on resource (contribution_contribution_id);
alter table resource add constraint fk_resource_location_29 foreign key (location_location_id) references geo (location_id);
create index ix_resource_location_29 on resource (location_location_id);
...
alter table appcivist_user add constraint fk_appcivist_user_role_51 foreign key (role_role_id) references role (role_id);
create index ix_appcivist_user_role_51 on appcivist_user (role_role_id);
alter table working_group add constraint fk_working_group_role_52 foreign key (role_role_id) references role (role_id);
create index ix_working_group_role_52 on working_group (role_role_id);
